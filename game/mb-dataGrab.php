            ...
            <th>
                ...
                <section class="downloaded">
                    ...
                    switch (strtolower($_GET['m'])) {
                        case 'quests2':
                            $XML_PAYLOAD = $Ninja->encryptNinja("<flash><strToken>" . $CREDTOKEN . "</strToken><intCharID>" . $CREDID . "</intCharID></flash>");
                            ...
                            for ($intQuestID = $TS; $intQuestID <= $TE; $intQuestID++) {
                                ...
                                if ($items->num_rows == 0) {
                                    $XML_PAYLOAD = $Ninja->encryptNinja("<flash><strToken>" . $CREDTOKEN . "</strToken><intCharID>" . $CREDID . "</intCharID><intQuestID>" . $intQuestID . "</intQuestID></flash>");
                        ...
                        case 'towns': //TEST - DO NOT USER
                            for ($intQuestID = $T2S; $intQuestID <= $T2E; $intQuestID++) {
                                $XML_PAYLOAD = $Ninja->encryptNinja("<flash><strToken>" . $CREDTOKEN . "</strToken><intCharID>" . $CREDID . "</intCharID><intTownID>" . $intQuestID . "</intTownID></flash>");
                        ...
                        case 'class':
                            for ($intClass = $CS; $intClass <= $CE; $intClass++) {
                                $XML_PAYLOAD = $Ninja->encryptNinja("<flash><strToken>" . $CREDTOKEN . "</strToken><intCharID>" . $CREDID . "</intCharID><intClassID>" . $intClass . "</intClassID></flash>");
                        ...
                        case 'shops':
                            for ($intShopID = $SS; $intShopID <= $SE; $intShopID++) {
                                $XML_PAYLOAD = $Ninja->encryptNinja("<flash><strToken>" . $CREDTOKEN . "</strToken><intCharID>" . $CREDID . "</intCharID><intShopID>" . $intShopID . "</intShopID></flash>");
                        ...
                        case 'merges':
                            for ($intMergeShop = $MSS; $intMergeShop <= $MSE; $intMergeShop++) {
                                $XML_PAYLOAD = $Ninja->encryptNinja("<flash><strToken>" . $CREDTOKEN . "</strToken><intCharID>" . $CREDID . "</intCharID><intMergeShopID>" . $intMergeShop . "</intMergeShopID></flash>");
                        ...
                        case 'hairs':
                            for ($intHairShop = $HSS; $intHairShop <= $HSE; $intHairShop++) {
                                $XML_PAYLOAD = $Ninja->encryptNinja("<flash><strToken>" . $CREDTOKEN . "</strToken><intCharID>" . $CREDID . "</intCharID><intHairShopID>" . $intHairShop . "</intHairShopID><strGender>M</strGender></flash>");
                                ...
                                $XML_PAYLOAD = $Ninja->encryptNinja("<flash><strToken>" . $CREDTOKEN . "</strToken><intCharID>" . $CREDID . "</intCharID><intHairShopID>" . $intHairShop . "</intHairShopID><strGender>F</strGender></flash>");
                                $XML_POST_URL = "http://dragonfable.battleon.com/game/cf-hairshopload.asp";
                                $result = $Files->dfCurl($XML_POST_URL, $XML_PAYLOAD);
                        ...
                        case 'chars':
                            for ($intChars = $CharS; $intChars <= $CharS; $intChars++) {
                                $XML_PAYLOAD = $Ninja->encryptNinja("<flash><strToken>" . $CREDTOKEN . "</strToken><intCharID>" . $CREDID . "</intCharID><intPVPCharID>" . $intChars . "</intPVPCharID></flash>");
                        ...
                        case 'interfaces':
                            for ($intInterface = $IS; $intInterface <= $IE; $intInterface++) {
                                $XML_PAYLOAD = $Ninja->encryptNinja("<flash><strToken>" . $CREDTOKEN . "</strToken><intCharID>" . $CREDID . "</intCharID><intInterfaceID>" . $intInterface . "</intInterfaceID></flash>");
